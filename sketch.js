...
// create an empty array and assign to drops variable
var drops=[]


//create maxDrops variable and assign 100 value
var maxDrops=100
...
function setup(){
    ...
    if(frameCount % 150 === 0){
        //using for loop, call constructor create drops and push in array
...
function draw(){
    ...
    //using for loop, call showDrop() and updateY() function
    for(var i=0;i<maxDrops;i++){
        drops[i].showDrop()
        drops[i].updateY()
    }
